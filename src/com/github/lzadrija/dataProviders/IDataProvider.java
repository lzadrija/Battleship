 ...
 * 
 *         This interface provides methods for sea map data extraction, such as
 *         number of rows and columns and if ship is located at a certain
 *         position on the map.
 * 
 */
public interface IDataProvider {
	 ...
	 * @param yCoordinate
	 *            y coordinate
	 * @return 1 - Ship is located in this position on the map 0 - There is no
	 *         ship on this position on the map
	 * @throws DataNotAvailableException
	...
	/**
	 * Returns the numerical representation of a HIT (if a ship is located at a
	 * certain position on the map). 1 is typically returned.
	 * 
	...
	/**
	 * Returns the numerical representation of a MISS (if a ship is not located
	 * at a certain position on the map). 0 is typically returned.
	 * 
