 ...
 * 
 *         This class provides information about sea map using web service. It
 *         uses token to request data from Google's service access servers.
 */
public class DataProvider implements IDataProvider {
	...
	private static final String TOKEN_URL = "https://script.google.com/macros/s/"
			+ "AKfycbzrtCcdp_GUx3rEypG6WgDZJ4lExmZy8IU"
			+ "-gxb2HwaYt_jPM2s/exec?method=GetToken";
	private static final String URL_PREFIX = "https://script.google.com/macros/s/"
			+ "AKfycbzrtCcdp_GUx3rEypG6WgDZJ4lExmZy8IU"
			+ "-gxb2HwaYt_jPM2s/exec?token=";
	 ...
	 *             If token is null.
	 */
	public DataProvider(String token) {
	...
	@Override
	public int getCellContent(int xCoordinate, int yCoordinate)
			throws DataNotAvailableException {

		StringBuilder urlSb = new StringBuilder();
		urlSb.append(URL_PREFIX).append(token).append(GET_CELL_METHOD)
				.append(CELL_ROW).append(yCoordinate).append(CELL_COLUMN)
				.append(xCoordinate);
